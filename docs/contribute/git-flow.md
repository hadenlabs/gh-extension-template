...
To contribute to gh-extension-template project on [GitHub](https://github.com/hadenlabs/gh-extension-template), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/gh-extension-template/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to gh-extension-template project on Gitlab:
...
```bash
git remote add upstream  https://github.com/hadenlabs/gh-extension-template.git
```

Now your **upstream** points to **hadenlabs/gh-extension-template**.
...
git fetch upstream # assuming upstream is rfid/gh-extension-template
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/gh-extension-template/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
